...
import { useDeleteFormulation } from '../../../Api/bachFormulationChange';

function DeleteBachFormulation({
  openDeleteModal,
  setOpenDeleteModal,
  selectedFormulation,
}) {
  ...
  const deleteReport = useDeleteFormulation();
...
export default DeleteBachFormulation;
