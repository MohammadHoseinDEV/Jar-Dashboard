...
function ReportActionBiWeeklyAmp({
  report,
  canEdit,
  canDelete,
  openEdit,
          ...
          <FloatingFocusManager context={context} modal={false}>
            ...
            >
              ...
              {((canEdit &&
                ...
                !report?.isExecutorSigned) ||
                (canEdit &&
                  isElectricalSupervisor &&
                  !report?.isSupervisorSigned) ||
                isSuperAdmin) && (
                <div
                  {...getItemProps({
                    onClick: (e) => {
              ...
              {((canDelete && !report?.isSupervisorSigned) || isSuperAdmin) && (
                <div
                  {...getItemProps({
                    onClick: (e) => {
                      e.preventDefault();
...
export default ReportActionBiWeeklyAmp;
