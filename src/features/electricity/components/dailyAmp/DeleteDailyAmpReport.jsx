...
import { useDeleteDailyAmpReport } from '../../Api/dailyAmp/dailyAmp';

function DeleteDailyAmpReport({
  openDeleteModal,
  setOpenDeleteModal,
  selectedDailyAmp,
}) {
  ...
  const deleteReports = useDeleteDailyAmpReport();
  return (
    <div
      ...
      >
        ...
        <div>
          ...
          <div
            ...
            onClick={() => {
              deleteReports.mutate(selectedDailyAmp?.id, {
                onSuccess: () => {
                  closeHandler();
                },
              });
...
export default DeleteDailyAmpReport;
