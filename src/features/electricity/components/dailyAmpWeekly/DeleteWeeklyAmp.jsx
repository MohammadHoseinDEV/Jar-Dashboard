...
import { useDeleteWeeklyAmp } from '../../Api/dailyAmpWeekly/WeeklyAmp';

function DeleteWeeklyAmp({
  openDeleteModal,
  setOpenDeleteModal,
  selectedWeeklyAmp,
}) {
  ...
  const deleteReports = useDeleteWeeklyAmp();
  return (
    <div
      ...
      >
        ...
        <div>
          ...
          <div
            ...
            onClick={() => {
              deleteReports.mutate(selectedWeeklyAmp?.id, {
                onSuccess: () => {
                  closeHandler();
                },
              });
...
export default DeleteWeeklyAmp;
