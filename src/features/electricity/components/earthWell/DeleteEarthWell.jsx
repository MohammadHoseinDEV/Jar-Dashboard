...
import { useDeleteEarthWell } from '../../Api/earthWell/earthWell';

function DeleteEarthWell({
  openDeleteModal,
  setOpenDeleteModal,
  selectedEarthWell,
}) {
  ...
  const deleteReports = useDeleteEarthWell();
      ...
      >
        ...
        <div>
          ...
          <div
            ...
            onClick={() => {
              deleteReports.mutate(selectedEarthWell?.id, {
                onSuccess: () => {
                  closeHandler();
                },
              });
...
export default DeleteEarthWell;
