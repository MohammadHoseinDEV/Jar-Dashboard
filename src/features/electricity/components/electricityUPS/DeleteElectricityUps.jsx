...
import { useDeleteElectricityReport } from '../../Api/electricityUPS/electricityUps';

function DeleteElectricityUps({
  openDeleteReport,
  setOpenDeleteReport,
  selectedReport,
}) {
  ...
  const deleteReport = useDeleteElectricityReport();
...
export default DeleteElectricityUps;
