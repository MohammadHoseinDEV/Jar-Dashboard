...
function ReportLinechangecheckList({
  report,
  canEdit,
  canDelete,
  openEdit,
          ...
          <FloatingFocusManager context={context} modal={false}>
            ...
            >
              ...
              {((canEdit &&
                ...
                !report?.isOperationsSupervisorSigned) ||
                (canEdit &&
              ...
              {((canDelete && !report?.isOperationsSupervisorSigned) ||
                isSuperAdmin) && (
                <div
                  {...getItemProps({
                    onClick: (e) => {
...
export default ReportLinechangecheckList;
