      ...
      >
        ...
        <div className="grid grid-cols-4 gap-4 max-md:grid-cols-1">
          ...
          <label
            ...
            className="max-4xl:text-[15px] 5xl:text-[21px] max-2xl:text-[11px] max-md:text-[11px]"
          >
        ...
        <div className="5xl:text-[25px] flex items-center space-x-5 max-md:grid max-md:grid-cols-1 max-md:gap-5">
          <p className="max-2xl:text-[12px] max-md:text-[13px]">
        ...
        <div className="grid grid-cols-4 space-y-5 max-md:grid-cols-1">
          <div className="flex items-center space-x-2 max-md:grid max-md:gap-3">
            <p className="5xl:text-[25px] max-2xl:text-[12px]">ابعادی</p>
            <label
          ...
          <div className="flex items-center space-x-2 max-md:grid max-md:gap-3">
            <p className="5xl:text-[25px] max-2xl:text-[12px]">وزن</p>
            <label
              className={`5xl:text-[25px] flex cursor-pointer items-center justify-center rounded-xl border-2 px-5 py-1 transition-all select-none max-2xl:px-3 max-2xl:text-[14px] max-md:w-full ${
          ...
          <div className="flex items-center space-x-2 max-md:grid max-md:gap-3">
            <p className="5xl:text-[25px] max-2xl:text-[12px]">حجم</p>
            <label
              className={`5xl:text-[25px] flex cursor-pointer items-center justify-center rounded-xl border px-5 py-1 transition-all select-none max-2xl:px-3 max-2xl:text-[14px] max-md:w-full ${
          ...
          <div className="flex items-center space-x-2 max-md:grid max-md:gap-3">
            <p className="5xl:text-[25px] max-2xl:text-[12px]">ضخامت</p>
            <label
              className={`5xl:text-[25px] flex cursor-pointer items-center justify-center rounded-xl border px-5 py-1 transition-all select-none max-2xl:px-3 max-2xl:text-[14px] max-md:w-full ${
          ...
          <div className="flex items-center space-x-2 max-md:grid max-md:gap-3">
            <p className="5xl:text-[25px] max-2xl:text-[12px]">روش بسته بندی</p>
            <label
              className={`5xl:text-[25px] flex cursor-pointer items-center justify-center rounded-xl border px-5 py-1 transition-all select-none max-2xl:px-3 max-2xl:text-[14px] max-md:w-full ${
        ...
        <div className="flex items-center space-x-5 max-md:flex-col">
          <label htmlFor="drawingNumber" className="5xl:text-[30px]">
            شماره نقشه
            <input
              type="text"
          ...
          <div className="flex items-center space-x-5 max-md:flex-col max-md:gap-2">
            <p className="5xl:text-[25px] max-2xl:text-[12px] max-md:text-[12px]">
            ...
            <label htmlFor="drawingReviewDate">
              <DatePicker
                ...
                className="5xl:scale-125"
                inputClass="w-full rounded-xl 5xl:text-[25px]  bg-white/10 max-2xl:text-[14px] p-3 font-[Samim] text-[18px] text-white outline-none"
              />
            </label>
            <p className="5xl:text-[25px] max-2xl:text-[12px]">
              بررسی و مورد تایید
            ...
            <label
              className={`5xl:text-[25px] flex cursor-pointer items-center justify-center rounded-xl border px-5 py-1 transition-all select-none max-2xl:text-[12px] max-md:m-auto max-md:w-full ${
            ...
            <label
              className={`5xl:text-[25px] flex cursor-pointer items-center justify-center rounded-xl border px-5 py-1 transition-all select-none max-2xl:text-[12px] max-md:w-full ${
        ...
        <div className="grid grid-cols-4 space-y-5 max-md:grid-cols-1">
          ...
          <div className="flex items-center space-x-2 max-md:grid max-md:gap-2">
            <p className="5xl:text-[25px] max-2xl:text-[12px]">تست شوک</p>
            <label
              className={`5xl:text-[25px] flex cursor-pointer items-center justify-center rounded-xl border px-5 py-1 transition-all select-none max-2xl:px-3 max-2xl:text-[14px] max-md:w-full ${
          ...
          <div className="flex items-center space-x-2 max-md:grid max-md:gap-2">
            <p className="5xl:text-[25px] max-2xl:text-[12px]">تست فشار</p>
            <label
              className={`5xl:text-[25px] flex cursor-pointer items-center justify-center rounded-xl border px-5 py-1 transition-all select-none max-2xl:px-3 max-2xl:text-[14px] max-md:w-full ${
...
export default CreateDesignDataJsx;
