...
import { useDeleteDesignMeeting } from '../../../Api/designMeeting';

function DeletedesignMeeting({
  openDeleteModal,
  setOpenDeleteModal,
  ...
  const deleteReports = useDeleteDesignMeeting();
  return (
    <div
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="5xl:text-[25px] flex flex-wrap pt-5 font-[SamimBold] max-md:text-[12px]">
            آیا از حذف فرم با نام محصول
          ...
          <div
            ...
            onClick={() => {
              deleteReports.mutate(selectedDesignMeeting?.id, {
                onSuccess: () => {
                  closeHandler();
                },
              });
...
export default DeletedesignMeeting;
