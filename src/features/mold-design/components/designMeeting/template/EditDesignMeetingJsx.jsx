    ...
    <div>
      ...
      >
        <div className="grid grid-cols-3 gap-4 max-md:flex max-md:flex-col">
          ...
          >
            ...
            <DatePicker
              ...
              value={form.meetingDate ? new Date(form.meetingDate) : ''}
          ...
          <label htmlFor="designPhase">
            فاز طراحی
            <input
              type="text"
              name="designPhase"
              value={form.designPhase || ''}
        ...
        <div className="grid grid-cols-4 gap-4 max-md:flex max-md:flex-col">
          <div>
            <p className="pb-2 max-2xl:text-[12px] max-md:text-[13px]">وزن</p>
            <label
          ...
          <div>
            <p className="pb-2 max-2xl:text-[12px] max-md:text-[13px]">
              تلرانس محصول
            </p>
            <label
              className={`5xl:text-[25px] flex cursor-pointer items-center justify-center rounded-xl border-2 px-5 py-1 transition-all select-none max-2xl:text-[14px] ${
...
export default EditDesignMeetingJsx;
