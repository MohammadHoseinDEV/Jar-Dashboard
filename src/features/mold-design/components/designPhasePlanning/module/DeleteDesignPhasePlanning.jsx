...
import { useDeleteDesignPhasePlanning } from '../../../Api/designPhasePlanning';

function DeleteDesignPhasePlanning({
  openDeleteModal,
  setOpenDeleteModal,
  selectedDesign,
}) {
  ...
  const deleteReport = useDeleteDesignPhasePlanning();
  return (
    <div
      ...
      >
        ...
        <div>
          ...
          <div
            ...
            onClick={() => {
              deleteReport.mutate(selectedDesign?.id, {
                onSuccess: () => {
                  closeHandler();
                },
              });
...
export default DeleteDesignPhasePlanning;
