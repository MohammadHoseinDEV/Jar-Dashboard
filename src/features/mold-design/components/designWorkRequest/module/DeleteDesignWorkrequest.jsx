...
import { useDeleteDesignWorkRequest } from '../../../Api/designWorkRequest';
import close from '../../../../../assets/images/close.png';

function DeleteDesignWorkrequest({
  openDeleteModal,
  setOpenDeleteModal,
  selectedWorkRequest,
}) {
  ...
  const deleteReport = useDeleteDesignWorkRequest();
      ...
      >
        ...
        <div>
          ...
          <div
            ...
            onClick={() => {
              deleteReport.mutate(selectedWorkRequest?.id, {
                onSuccess: () => {
                  closeHandler();
                },
              });
...
export default DeleteDesignWorkrequest;
