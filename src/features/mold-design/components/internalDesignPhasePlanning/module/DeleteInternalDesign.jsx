...
import { useDeleteInternalDesignPhasePlanning } from '../../../Api/internalDesignPhasePlanning';

function DeleteInternalDesign({
  openDeleteModal,
  setOpenDeleteModal,
  selectedInternal,
}) {
  ...
  const deleteReport = useDeleteInternalDesignPhasePlanning();
  return (
    <div
      ...
      >
        ...
        <div>
          ...
          <div
            ...
            onClick={() => {
              deleteReport.mutate(selectedInternal?.id, {
                onSuccess: () => {
                  closeHandler();
                },
              });
...
export default DeleteInternalDesign;
