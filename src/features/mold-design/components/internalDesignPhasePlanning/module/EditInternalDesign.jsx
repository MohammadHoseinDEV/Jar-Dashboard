...
function EditInternalDesign({
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      productNameOrSampleCode: selectedInternal?.productNameOrSampleCode,
  ...
  const selectedProducts = useMemo(() => {
    return (
      getProducts.find((p) => p.name === form.productNameOrSampleCode) ||
      getProducts[0]
    );
  }, [getProducts, form.productNameOrSampleCode]);
