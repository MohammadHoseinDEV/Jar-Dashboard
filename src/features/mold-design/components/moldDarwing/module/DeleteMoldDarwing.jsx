...
import { useDeleteMoldDarwing } from '../../../Api/moldDarwing';

function DeleteMoldDarwing({
  openDeleteModal,
  setOpenDeleteModal,
  selectedMoldDarwing,
  ...
  const deleteReports = useDeleteMoldDarwing();
  return (
    <div
      ...
      >
        ...
        <div>
          ...
          <div
            ...
            onClick={() => {
              deleteReports.mutate(selectedMoldDarwing?.id, {
                onSuccess: () => {
                  closeHandler();
                },
              });
...
export default DeleteMoldDarwing;
