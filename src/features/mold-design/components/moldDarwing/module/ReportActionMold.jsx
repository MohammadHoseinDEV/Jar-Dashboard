...
function ReportActionMold({
  ...
  const isFactoryManager = profile?.data?.companyRoles?.some(
    (p) => p.roleId === '8132dd4b-2e30-458d-a9f4-7e3bb4c344db'
  );
...
export default ReportActionMold;
