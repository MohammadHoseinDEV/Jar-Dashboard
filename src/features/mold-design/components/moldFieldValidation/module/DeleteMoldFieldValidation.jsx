...
import { useDeleteMoldFieldValidation } from '../../../Api/moldFieldValidation';
import close from '../../../../../assets/images/close.png';

function DeleteMoldFieldValidation({
  openDeleteModal,
  setOpenDeleteModal,
  selectedMold,
}) {
  ...
  const deleteReports = useDeleteMoldFieldValidation();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="5xl:text-[25px] flex flex-wrap items-center pt-5 font-[SamimBold]">
            آیا از حذف فرم شماره
            <span className="font-[AvenirLTProMedium]" dir="ltr">
          ...
          <div
            ...
            onClick={() => {
              deleteReports.mutate(selectedMold?.id, {
                onSuccess: () => {
                  closeHandler();
                },
              });
...
export default DeleteMoldFieldValidation;
