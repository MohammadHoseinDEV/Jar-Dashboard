...
function CreateMoldFieldValidationJsx({
  closeHandler,
  submitHandler,
  form,
  setForm,
    ...
    <div>
      ...
      >
        ...
        <div className="flex items-center space-x-1 max-md:grid max-md:grid-cols-1 max-md:space-y-2">
          <p className="5xl:text-[25px] max-md:text-[15px]">
          ...
          <p className="5xl:text-[25px] max-md:text-[13px]">
        ...
        <p className="5xl:text-[30px] my-2 border-t-2 border-white/30 py-1 max-md:text-[13px]">
          ملاحظات (شرح تغییرات مورد نیاز به شرح ذیل می باشد) :
        </p>
        <div className="flex space-x-10 max-md:grid max-md:grid-cols-1 max-md:space-x-0">
          ...
          <div className="flex items-center gap-2 max-md:grid max-md:grid-cols-1 max-md:pb-2">
...
export default CreateMoldFieldValidationJsx;
