...
function HeaderPage({
  ...
  return (
    <div className="w-full">
        ...
        <div className="mx-2 mt-1 flex items-center justify-between border-b border-white/30 pb-3 max-2xl:pb-1">
          ...
          <div className="flex items-center space-x-5 pl-5 text-white max-md:hidden">
            ...
            <p className="5xl:text-[20px] space-x-1 text-[12px] max-2xl:text-[10px]">
              ...
              <span className="font-[AvenirLTProMedium]">F1008</span>
            </p>
          </div>
        </div>
        {/* Add Reports & Excel */}
      ...
      {/* data reports */}
      <div className="mx-10 mt-1 grid grid-cols-4 gap-6 space-x-2 max-2xl:mx-5 max-2xl:gap-0 max-md:hidden">
        <div
      ...
      <div className="mx-2 hidden max-md:block">
        <div className="my-3 rounded-[10px] border border-[#3a35a0] bg-linear-to-l from-[#201c66] to-[#1d1952] p-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <p className="text-[15px] font-bold">فرم صحه گذاری میدانی قالب </p>
          </div>
          {/* Details Report */}
          <div className="mt-2 grid grid-cols-3 gap-3">
            <p className="flex flex-col items-center justify-center rounded-[10px] bg-[#343181] py-2">
              ...
              <span className="text-[] font-[AvenirLTProMedium]">F1008</span>
            </p>
            <p className="flex flex-col items-center justify-center rounded-[10px] bg-[#343181] py-2">
              <span className="text-[11px] font-bold text-[#5e7ef8]">
                شماره ویرایش
        ...
        <div className="mb-2 flex items-center justify-between">
          ...
          >
            ...
            {openFilterMobile && (
              <div className="absolute top-1 left-11 flex flex-col justify-center space-y-2 overflow-auto rounded-[10px] border border-[#3a35a0] bg-linear-to-l from-[#201c66] to-[#1d1952] p-2 whitespace-nowrap">
                <p
                  onClick={() => {
                    setFilterStatus('all');
                  }}
