...
function MobileMoldFieldValidation({
  filteredData,
  openEdit,
  canEdit,
  setOpenEditModal,
              ...
              <div className="flex items-center">
                {(() => {
                  ...
                  if (e?.isProductionManagerSigned === false) {
                    return (
                      <p className="rounded-[10px] border bg-[#262627]/70 p-1 text-[#f9e2af] max-md:text-[10px]">
            ...
            <div className="mx-2 grid grid-cols-7 gap-2">
              <button
                ...
                className={`col-span-3 mb-2 flex cursor-pointer items-center justify-center rounded-[10px] p-1 font-[Samim] ${
                  (canEdit && e?.isDesignerSigned === false) || isSuperAdmin
              ...
              <button
                ...
                className={`mb-2 flex cursor-pointer items-center justify-center rounded-[10px] p-2 font-[Samim] ${
                  (canDelete && e?.isDesignerSigned === false) || isSuperAdmin
...
export default MobileMoldFieldValidation;
