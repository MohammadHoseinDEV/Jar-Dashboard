...
function EditProductionWeightStandardJsx({
  closeHandler,
  submitHandler,
  form,
  setForm,
        ...
        <div className="grid grid-cols-3 gap-4 max-md:grid-cols-1">
          <label htmlFor="weightToleranceLine1">
            ...
            <input
              ...
              value={form?.weightToleranceLine1 || ''}
              onChange={(e) => {
                setForm((p) => ({
                  ...p,
                  [e.target.name]: e.target.value,
          ...
          <label htmlFor="weightToleranceLine2">
            ...
            <input
              ...
              value={form?.weightToleranceLine2 || ''}
              onChange={(e) => {
                setForm((p) => ({
                  ...p,
                  [e.target.name]: e.target.value,
          ...
          <label htmlFor="weightToleranceLine3">
            ...
            <input
              ...
              value={form?.weightToleranceLine3 || ''}
              onChange={(e) => {
                setForm((p) => ({
                  ...p,
                  [e.target.name]: e.target.value,
...
export default EditProductionWeightStandardJsx;
