      ...
      <FloatingPortal>
        {isOpen && (
          <FloatingFocusManager context={context} modal={false}>
            ...
            >
              <div className="flex w-full items-center space-x-1 border-b border-white/50 p-1 text-white max-2xl:text-[15px]">
...
export default ReportActionCustomer;
