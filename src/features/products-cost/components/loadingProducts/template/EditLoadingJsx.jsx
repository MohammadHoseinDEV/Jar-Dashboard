  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      >
        <div className="grid grid-cols-4 gap-3 py-2 max-md:grid-cols-1">
          <label htmlFor="LoadingDate" className="flex flex-col">
            ...
            <DatePicker
              ...
              value={form.LoadingDate ? new Date(form.LoadingDate) : ''}
        ...
        <div className="my-5 grid grid-cols-4 gap-5 max-md:grid-cols-1">
          ...
          <label htmlFor="LoadingStartTime">
            ساعت شروع بارگیری
            <TimePickerInput
              value={normalizeTime(form.LoadingStartTime)}
              onChange={(value) =>
                setForm((prev) => ({
                  ...prev,
          ...
          <label htmlFor="LoadingEndTime">
            ساعت پایان بارگیری
            <TimePickerInput
              value={normalizeTime(form.LoadingEndTime)}
              onChange={(value) =>
                setForm((prev) => ({
                  ...prev,
      ...
      <div className="my-2 text-left">
        <button type="submit" form="loadingProduct" className="btn-submit">
          ثبت گزارش
        </button>
      </div>
    </div>
