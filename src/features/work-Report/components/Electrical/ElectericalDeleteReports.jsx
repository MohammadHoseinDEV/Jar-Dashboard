...
import { useDeleteElectricalReports } from '../../Api/Electrical/electrical';

function ElectericalDeleteReports({
  openDeleteModal,
  setOpenDeleteModal,
  selectedElectrical,
}) {
  ...
  const deleteRepots = useDeleteElectricalReports();
  return (
    <div
        ...
        <div>
          <h4 className="pt-5 font-[SamimBold]">
            ...
            <span className="px-2 font-[AvenirLTProMedium]" dir="ltr">
              {selectedElectrical?.reportNumber}
            </span>
            مطمئن هستید؟
          </h4>
          <div
            ...
            onClick={() => {
              deleteRepots.mutate(selectedElectrical?.id, {
                onSuccess: () => {
                  closeHandler();
                },
              });
...
export default ElectericalDeleteReports;
