...
import { useCreateElectricalReports } from '../../Api/Electrical/electrical';

function ElectricalCreateReports({ openCreateModal, setOpenCreateModal }) {
  const [form, setForm] = useState({
    ...
    inspection_Generators: false,
    inspection_Batteries: false,
    inspection_UPS: false,
    inspection_MainSwitches: false,
    distributionRoomTemperature: 0,
    substationRoomTemperature: 0,
    airCompressor1_Working: false,
    airCompressor2_Working: false,
    airCompressor3_Working: false,
    airCompressor4_Working: false,
    cleaning_DistributionRoom: false,
    cleaning_ElectricalRoom: false,
    lighting_Yard: false,
    lighting_Hall: false,
  ...
  const createElectricalReports = useCreateElectricalReports();
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    createElectricalReports.mutate(form, {
      onSuccess: () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative flex max-h-[90vh] w-[1000px] max-w-[95vw] transform flex-col rounded-[15px] bg-linear-to-bl from-black to-gray-600 p-6 text-white shadow-2xl transition-all duration-300 max-2xl:scale-95 max-md:h-160 max-md:overflow-auto ${
          openCreateModal
        ...
        >
          ...
          <div className="grid grid-cols-4 gap-2 max-md:flex max-md:flex-col">
            <label htmlFor="presentPersonnel">
              ...
              <input
                ...
                className="w-full rounded-xl bg-white/10 p-3 font-[AvenirLTProMedium] text-[18px] text-white outline-none placeholder:font-[Samim]"
              />
            </label>
          ...
          <div className="grid grid-cols-4 gap-5 max-md:flex max-md:flex-col">
            <label htmlFor="airCompressor1_Working">
              ...
              <input
                type="checkbox"
                value={form?.airCompressor1_Working}
                onChange={(e) => {
                  setForm((p) => ({
                    ...p,
            ...
            <label htmlFor="airCompressor2_Working">
              ...
              <input
                type="checkbox"
                value={form?.airCompressor2_Working}
                onChange={(e) => {
                  setForm((p) => ({
                    ...p,
            ...
            <label htmlFor="airCompressor3_Working">
              ...
              <input
                type="checkbox"
                value={form?.airCompressor3_Working}
                onChange={(e) => {
                  setForm((p) => ({
                    ...p,
            ...
            <label htmlFor="airCompressor4_Working">
              ...
              <input
                type="checkbox"
                value={form?.airCompressor4_Working}
                onChange={(e) => {
                  setForm((p) => ({
                    ...p,
          ...
          <div className="flex flex-col gap-2 max-md:flex max-md:flex-col">
            {(form?.workTasks || []).map((item, index) => (
              ...
              >
                ...
                <div className="grid grid-cols-5 gap-2 rounded-[10px] max-md:flex max-md:flex-col">
...
export default ElectricalCreateReports;
