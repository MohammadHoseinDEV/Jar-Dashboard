...
import { useCreateFacilityReports } from '../../Api/Facility/facility';
...
function CreateFacilityReports({ openCreateReport, setOpenCreateReport }) {
  ...
  const createReports = useCreateFacilityReports();
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative flex max-h-[90vh] w-[1000px] max-w-[95vw] flex-col gap-4 overflow-hidden rounded-[15px] bg-linear-to-bl from-black to-gray-600 p-6 text-white shadow-2xl transition-all duration-300 max-xl:w-[850px] ${
          openCreateReport
...
export default CreateFacilityReports;
