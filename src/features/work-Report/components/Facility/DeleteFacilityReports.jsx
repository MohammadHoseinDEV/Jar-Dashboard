...
import { useDeleteFacilityReport } from '../../Api/Facility/facility';

function DeleteFacilityReports({
  openDeleteForm,
  setOpenDeleteForm,
  selectedFacility,
}) {
  ...
  const deleteReport = useDeleteFacilityReport();

  const deleteHandler = () => {
    deleteReport.mutate(selectedFacility?.id, {
      onSuccess: () => {
        setOpenDeleteForm(false);
      },
    });
...
export default DeleteFacilityReports;
