...
import { useDeleteReport } from '../../Api/MachiningWorkReport/machiningApi';

function DeleteMachiningReport({
  openDeleteReports,
  setOpenDeleteReports,
  selectedReports,
}) {
  const closeHandler = () => {
    setOpenDeleteReports(false);
  };
...
export default DeleteMachiningReport;
