...
import { useDeleteMechanicalReports } from '../../Api/Mechanical/mechanical';

function DeleteMechanicalReports({
  openDeleteReport,
  setOpenDeleteReport,
  selectedMechanical,
  ...
  const deleteReports = useDeleteMechanicalReports();

  const deleteHandler = () => {
    deleteReports.mutate(selectedMechanical?.id, {
      onSuccess: () => {
        setOpenDeleteReport(false);
...
export default DeleteMechanicalReports;
