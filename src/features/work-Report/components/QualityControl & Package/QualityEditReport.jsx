...
import { useUpdateQualityReport } from '../../Api/QualityControl & Package/quality';

function QualityEditReport({
  openEditReport,
  setOpenEditReport,
  selectedQuality,
  setSelectedQuality,
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      reportDate: selectedQuality?.reportDate,
      shift: selectedQuality?.shift,
      personnelName: selectedQuality?.personnelName,
      line1_ProductName: selectedQuality?.line1_ProductName,
      line1_MachineSpeed: selectedQuality?.line1_MachineSpeed,
      line1_ProductWeight: selectedQuality?.line1_ProductWeight,
      line1_OvenChainSpeed: selectedQuality?.line1_OvenChainSpeed,
      line1_CountPerTray: selectedQuality?.line1_CountPerTray,
      line1_CountPerPallet: selectedQuality?.line1_CountPerPallet,
      line1_Shrinking: selectedQuality?.line1_Shrinking,
      line1_Cellophane: selectedQuality?.line1_Cellophane,
      line1_Palletizing: selectedQuality?.line1_Palletizing,
      line2_ProductName: selectedQuality?.line2_ProductName,
      line2_MachineSpeed: selectedQuality?.line2_MachineSpeed,
      line2_ProductWeight: selectedQuality?.line2_ProductWeight,
      line2_OvenChainSpeed: selectedQuality?.line2_OvenChainSpeed,
      line2_CountPerTray: selectedQuality?.line2_CountPerTray,
      line2_CountPerPallet: selectedQuality?.line2_CountPerPallet,
      line2_Shrinking: selectedQuality?.line2_Shrinking,
      line2_Cellophane: selectedQuality?.line2_Cellophane,
      line2_Palletizing: selectedQuality?.line2_Palletizing,
      line3_ProductName: selectedQuality?.line3_ProductName,
      line3_MachineSpeed: selectedQuality?.line3_MachineSpeed,
      line3_ProductWeight: selectedQuality?.line3_ProductWeight,
      line3_OvenChainSpeed: selectedQuality?.line3_OvenChainSpeed,
      line3_CountPerTray: selectedQuality?.line3_CountPerTray,
      line3_CountPerPallet: selectedQuality?.line3_CountPerPallet,
      line3_Shrinking: selectedQuality?.line3_Shrinking,
      line3_Cellophane: selectedQuality?.line3_Cellophane,
      line3_Palletizing: selectedQuality?.line3_Palletizing,
      mpC_Line1_FailureReport: selectedQuality?.mpC_Line1_FailureReport,
      mpC_Line1_SettingsReport: selectedQuality?.mpC_Line1_SettingsReport,
      mpC_Line1_WasteStatistics: selectedQuality?.mpC_Line1_WasteStatistics,
      mpC_Line2_FailureReport: selectedQuality?.mpC_Line2_FailureReport,
      mpC_Line2_SettingsReport: selectedQuality?.mpC_Line2_SettingsReport,
      mpC_Line2_WasteStatistics: selectedQuality?.mpC_Line2_WasteStatistics,
      mpC_Line3_FailureReport: selectedQuality?.mpC_Line3_FailureReport,
      mpC_Line3_SettingsReport: selectedQuality?.mpC_Line3_SettingsReport,
      mpC_Line3_WasteStatistics: selectedQuality?.mpC_Line3_WasteStatistics,
      ebI_Line1_FailureReport: selectedQuality?.ebI_Line1_FailureReport,
      ebI_Line1_SettingsReport: selectedQuality?.ebI_Line1_SettingsReport,
      ebI_Line1_WasteStatistics: selectedQuality?.ebI_Line1_WasteStatistics,
      ebI_Line2_FailureReport: selectedQuality?.ebI_Line2_FailureReport,
      ebI_Line2_SettingsReport: selectedQuality?.ebI_Line2_SettingsReport,
      ebI_Line2_WasteStatistics: selectedQuality?.ebI_Line2_WasteStatistics,
      ebI_Line3_FailureReport: selectedQuality?.ebI_Line3_FailureReport,
      ebI_Line3_SettingsReport: selectedQuality?.ebI_Line3_SettingsReport,
      ebI_Line3_WasteStatistics: selectedQuality?.ebI_Line3_WasteStatistics,
      packagingLine_FailureReport: selectedQuality?.packagingLine_FailureReport,
      packagingLine_SettingsReport:
        selectedQuality?.packagingLine_SettingsReport,
      quarantinePallets_Statistics:
        selectedQuality?.quarantinePallets_Statistics,
      quarantinePallets_Line1: selectedQuality?.quarantinePallets_Line1,
      quarantinePallets_Line2: selectedQuality?.quarantinePallets_Line2,
      quarantinePallets_Line3: selectedQuality?.quarantinePallets_Line3,
    });
  }, [selectedQuality]);
  const closeModal = () => {
  ...
  const updateReport = useUpdateQualityReport();

  const submitHandler = (e) => {
    e.preventDefault();
    updateReport.mutate(
      { id: selectedQuality?.id, form },
      {
        onSuccess: () => {
          setOpenEditReport(false);
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`relative flex max-h-[90vh] w-[1000px] max-w-[95vw] flex-col gap-4 overflow-hidden rounded-[15px] bg-linear-to-tl from-black to-gray-600 p-6 text-white shadow-2xl transition-all duration-300 max-2xl:w-[900px] ${
          openEditReport
          ...
          <div className="grid grid-cols-4 gap-5 max-md:grid-cols-1">
            <label htmlFor="quarantinePallets_Statistics">
              ...
              <input
                ...
                value={form.quarantinePallets_Statistics}
            ...
            <label htmlFor="quarantinePallets_Line1">
              ...
              <input
                ...
                value={form.quarantinePallets_Line1}
                placeholder="خط 1"
                maxLength={180}
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="quarantinePallets_Line2">
              ...
              <input
                ...
                value={form.quarantinePallets_Line2}
                placeholder="خط 2"
                maxLength={180}
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="quarantinePallets_Line3">
              ...
              <input
                ...
                value={form.quarantinePallets_Line3}
                placeholder="خط 3"
                maxLength={180}
                onChange={(e) => {
                  setForm((p) => ({
          ...
          <div className="grid grid-cols-3 gap-5 max-md:grid-cols-1">
            ...
            <label htmlFor="line1_ProductWeight">
              ...
              <input
                ...
                value={form.line1_ProductWeight}
            ...
            <label htmlFor="line1_OvenChainSpeed">
              ...
              <input
                ...
                value={form.line1_OvenChainSpeed}
            ...
            <label htmlFor="line1_CountPerPallet">
              ...
              <input
                ...
                value={form.line1_CountPerPallet}
          ...
          <div className="grid grid-cols-3 gap-5 max-md:grid-cols-1">
            ...
            <label htmlFor="line2_ProductWeight">
              ...
              <input
                ...
                value={form.line2_ProductWeight}
            ...
            <label htmlFor="line2_OvenChainSpeed">
              ...
              <input
                ...
                value={form.line2_OvenChainSpeed}
            ...
            <label htmlFor="line2_CountPerPallet">
              ...
              <input
                ...
                value={form.line2_CountPerPallet}
          ...
          <div className="grid grid-cols-3 gap-5 max-md:grid-cols-1">
            ...
            <label htmlFor="line3_ProductWeight">
              ...
              <input
                ...
                value={form.line3_ProductWeight}
            ...
            <label htmlFor="line3_OvenChainSpeed">
              ...
              <input
                ...
                value={form.line3_OvenChainSpeed}
            ...
            <label htmlFor="line3_CountPerPallet">
              ...
              <input
                ...
                value={form.line3_CountPerPallet}
          ...
          <div className="grid grid-cols-3 gap-5 max-md:grid-cols-1">
            <label htmlFor="mpC_Line1_FailureReport">
              ...
              <input
                ...
                value={form.mpC_Line1_FailureReport}
            ...
            <label htmlFor="mpC_Line1_SettingsReport">
              ...
              <input
                ...
                value={form.mpC_Line1_SettingsReport}
            ...
            <label htmlFor="mpC_Line1_WasteStatistics">
              ...
              <input
                ...
                value={form.mpC_Line1_WasteStatistics}
            ...
            <label htmlFor="mpC_Line2_FailureReport">
              ...
              <input
                ...
                value={form.mpC_Line2_FailureReport}
                placeholder="اعلام خرابی ها"
                maxLength={75}
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="mpC_Line2_SettingsReport">
              ...
              <input
                ...
                value={form.mpC_Line2_SettingsReport}
                maxLength={45}
                placeholder="اعلام تنظیمات توسط واحد اعمال کننده"
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="mpC_Line2_WasteStatistics">
              ...
              <input
                ...
                value={form.mpC_Line2_WasteStatistics}
                placeholder="آمار ضایعات"
                onChange={(e) => {
                  setForm((p) => ({
                    ...p,
            ...
            <label htmlFor="mpC_Line3_FailureReport">
              ...
              <input
                ...
                value={form.mpC_Line3_FailureReport}
                placeholder="اعلام خرابی ها"
                maxLength={75}
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="mpC_Line3_SettingsReport">
              ...
              <input
                ...
                value={form.mpC_Line3_SettingsReport}
                maxLength={45}
                placeholder="اعلام تنظیمات توسط واحد اعمال کننده"
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="mpC_Line3_WasteStatistics">
              ...
              <input
                ...
                value={form.mpC_Line3_WasteStatistics}
                placeholder="آمار ضایعات"
                onChange={(e) => {
                  setForm((p) => ({
                    ...p,
          ...
          <div className="grid grid-cols-3 gap-5 max-md:grid-cols-1">
            <label htmlFor="ebI_Line1_FailureReport">
              ...
              <input
                ...
                value={form.ebI_Line1_FailureReport}
                placeholder="اعلام خرابی ها"
                max={75}
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="ebI_Line1_SettingsReport">
              ...
              <input
                ...
                value={form.ebI_Line1_SettingsReport}
                placeholder="اعلام تنظیمات توسط واحد اعمال کننده"
                maxLength={45}
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="ebI_Line1_WasteStatistics">
              ...
              <input
                ...
                value={form.ebI_Line1_WasteStatistics}
                placeholder="آمار ضایعات"
                onChange={(e) => {
                  setForm((p) => ({
                    ...p,
            ...
            <label htmlFor="ebI_Line2_FailureReport">
              ...
              <input
                ...
                value={form.ebI_Line2_FailureReport}
                placeholder="اعلام خرابی ها"
                maxLength={75}
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="ebI_Line2_SettingsReport">
              ...
              <input
                ...
                value={form.ebI_Line2_SettingsReport}
                placeholder="اعلام تنظیمات توسط واحد اعمال کننده"
                maxLength={45}
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="ebI_Line2_WasteStatistics">
              ...
              <input
                ...
                value={form.ebI_Line2_WasteStatistics}
                placeholder="آمار ضایعات"
                onChange={(e) => {
                  setForm((p) => ({
                    ...p,
            ...
            <label htmlFor="ebI_Line3_FailureReport">
              ...
              <input
                ...
                value={form.ebI_Line3_FailureReport}
                placeholder="اعلام خرابی ها"
                maxLength={75}
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="ebI_Line3_SettingsReport">
              ...
              <input
                ...
                value={form.ebI_Line3_SettingsReport}
                placeholder="اعلام تنظیمات توسط واحد اعمال کننده"
                maxLength={45}
                onChange={(e) => {
                  setForm((p) => ({
            ...
            <label htmlFor="ebI_Line3_WasteStatistics">
              ...
              <input
                ...
                value={form.ebI_Line3_WasteStatistics}
                placeholder="آمار ضایعات"
                onChange={(e) => {
                  setForm((p) => ({
                    ...p,
          ...
          <div className="grid grid-cols-2 gap-5 max-md:grid-cols-1">
            <label htmlFor="packagingLine_FailureReport">
              ...
              <input
                ...
                value={form.packagingLine_FailureReport}
            ...
            <label htmlFor="packagingLine_SettingsReport">
              ...
              <input
                ...
                value={form.packagingLine_SettingsReport}
...
export default QualityEditReport;
